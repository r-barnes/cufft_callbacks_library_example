...
all:
	...
	nvcc -I/usr/local/cuda/include/ -g -G -ccbin g++ -m64 -arch=sm_61 -Xcompiler -fPIC,-g -dc -o kernels.o -c kernels.cu 
	...
	nvcc -I/usr/local/cuda/include/ -g -G -ccbin g++ -m64 -arch=sm_61 -Xcompiler -fPIC,-g -lib -o kernels.a kernels.o #kernels.dlink.o
	#host code compilation
	g++ -I/usr/local/cuda/include/ -g -m64 -fPIC -o libmain.o -c libmain.cpp
	#host (final) link phase - the order of entries on this line is important!!
	nvcc -I/usr/local/cuda/include/ -g -G -m64 libmain.o kernels.a -o libmain.so -shared -L/usr/local/cuda/lib64 -lcudart -lcufft_static -lculibos
